...
/>
      ...
      <aside className={`
        flex flex-col items-center font-['Inter'] min-h-[calc(100vh-60px)] overflow-hidden p-4 bg-[#728a9c] text-[#121731] transition-all duration-300 ease-in-out fixed left-0 top-[60px] z-50
