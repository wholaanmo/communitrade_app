...
export default function AdminSidebar({ isOpen, onToggle }) {
  ...
  const menuItems = [
    { href: "/admin/users", icon: "group", label: "Management" },
    { href: "/admin/req", icon: "assignment", label: "Requests" },
    { href: "/admin/off", icon: "front_hand", label: "Offers" },
    { href: "/admin/acc", icon: "account_circle", label: "My Account" },
  ]
  ...
  return (
    <>
      ...
      <aside className={`
        flex flex-col items-center font-['Inter'] h-[calc(100vh-60px)] overflow-y-auto p-4 bg-[#728a9c] text-[#121731] transition-all duration-300 ease-in-out fixed left-0 top-[60px] z-50
