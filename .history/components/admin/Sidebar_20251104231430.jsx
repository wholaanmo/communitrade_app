...
export default function Sidebar({ isOpen, onToggle }) {
  ...
  return (
    <aside className={`
      flex flex-col items-center font-['Inter'] min-h-[calc(100vh-60px)] overflow-hidden p-4 bg-[#728a9c] text-[#121731] transition-all duration-500 ease-out fixed left-0 top-[60px] z-50
    ...
    `}>
      ...
      `}>
        <Link href="/admin/users" onClick={handleLinkClick} className={`
        ...
        <Link href="/admin/req" onClick={handleLinkClick} className={`
          group button flex items-center no-underline p-4 transition-all duration-200 ease-out rounded-lg mb-2 hover:bg-white
          ${is_expanded ? 'justify-start' : 'justify-center w-full'}
        `}>
        ...
        <Link href="/admin/off" onClick={handleLinkClick} className={`
          group button flex items-center no-underline p-4 transition-all duration-200 ease-out rounded-lg mb-2 hover:bg-white
          ${is_expanded ? 'justify-start' : 'justify-center w-full'}
        `}>
        ...
        <Link href="/admin/acc" onClick={handleLinkClick} className={`
          group button flex items-center no-underline p-4 transition-all duration-200 ease-out rounded-lg mb-2 hover:bg-white
          ${is_expanded ? 'justify-start' : 'justify-center w-full'}
        `}>
