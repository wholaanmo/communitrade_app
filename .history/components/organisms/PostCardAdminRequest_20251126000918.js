...
export default function PostCardAdminRequest({
  post,
  isReported = false,
  onDelete,
  onContact,
  ...
  return (
    <Card hover className={`min-h-[580px] flex flex-col ${className}`}>
      ...
      <div className="p-5 flex-1">
        <h2 className="text-[#121731] text-xl font-semibold mb-4">{request}</h2>
        ...
        <div className="grid grid-cols-2 gap-4 mb-5">
          ...
          <div className="flex flex-col">
            ...
            <SmallText>{skillsOffered}</SmallText>
          </div>
          <div className="flex flex-col">
        ...
        {/* Report Reason for Reported Posts */}
