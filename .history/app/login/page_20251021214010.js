...
export default function Login() {
    ...
    const resendVerificationEmail = async () => {
        ...
        try {
            // Firebase verification email code would go here
    ...
    return (
        <>
            ...
            <div className="min-h-screen w-full bg-cover bg-center bg-no-repeat bg-fixed flex justify-center items-center p-5" style={{ backgroundImage: "url('/assets/background.png')" }}>
