...
export default function Login() {
    ...
    return (
        <>
            ...
            <div className="flex justify-center items-center min-h-screen w-full p-5 bg-cover bg-center bg-no-repeat bg-fixed" style={{ backgroundImage: "url('/background.png')" }}>
