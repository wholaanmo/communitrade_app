  ...
  return (
    <>
      ...
      <nav className="navbar fixed top-0 left-0 right-0 h-[70px] bg-[#728a9c] bg-opacity-90 text-[#728a9c] z-50 shadow-lg px-8">
        <div className="navbar-content flex items-center justify-between h-full max-w-7xl mx-auto">
          <div className="navbar-left flex items-center gap-60">
            <div className="logo-container flex items-center gap-2">
              ...
              <p className="logo-text font-bold text-xl text-[#121731]">
                Communi<span className="logo-text1 text-white">Trade</span>
              </p>
            </div>
            
            <div className="nav-links hidden md:flex gap-8">
              <a href="#home" className="nav-link text-white font-medium py-2 relative transition-all duration-300 hover:text-[#121731]">
                Home
              </a>
              <a href="#services" className="nav-link text-white font-medium py-2 relative transition-all duration-300 hover:text-[#121731]">
                Services
              </a>
              <a href="#guide" className="nav-link text-white font-medium py-2 relative transition-all duration-300 hover:text-[#121731]">
                Guide
              </a>
              <a href="#footer" className="nav-link text-white font-medium py-2 relative transition-all duration-300 hover:text-[#121731]">
                Contact Us
              </a>
            </div>
          </div>
          ...
          <div className="navbar-right flex items-center">
            ...
            <button 
              className="mobile-menu-btn md:hidden flex flex-col justify-around w-8 h-6 bg-transparent border-none cursor-pointer p-0 ml-4"
      ...
      {/* Sidebar */}
      <div 
        className={`sidebar fixed top-0 left-[-300px] w-80 h-full bg-[#728a9c] z-50 transition-left duration-300 overflow-y-auto shadow-xl ${
          sidebarOpen ? 'left-0' : ''
        }`}
      >
        <div className="sidebar-header p-6 border-b border-opacity-10">
          <div className="logo-container flex items-center gap-2">
            <Image 
              src="/assets/CommuniTrade.png" 
              alt="CommuniTrade Logo" 
        ...
        <div className="sidebar-links flex flex-col p-6">
          <a href="#home" className="sidebar-link text-white no-underline py-3 px-5 font-medium block rounded-lg transition-all duration-300 border-b border-opacity-10 hover:text-[#121731] hover:bg-white hover:translate-x-1" onClick={closeSidebar}>
            Home
          </a>
          <a href="#services" className="sidebar-link text-white no-underline py-3 px-5 font-medium block rounded-lg transition-all duration-300 border-b border-opacity-10 hover:text-[#121731] hover:bg-white hover:translate-x-1" onClick={closeSidebar}>
            Services
          </a>
          <a href="#guide" className="sidebar-link text-white no-underline py-3 px-5 font-medium block rounded-lg transition-all duration-300 border-b border-opacity-10 hover:text-[#121731] hover:bg-white hover:translate-x-1" onClick={closeSidebar}>
            Guide
          </a>
          <a href="#footer" className="sidebar-link text-white no-underline py-3 px-5 font-medium block rounded-lg transition-all duration-300 border-b border-opacity-10 hover:text-[#121731] hover:bg-white hover:translate-x-1" onClick={closeSidebar}>
            Contact Us
          </a>
        </div>
      </div>
      ...
      <section id="home" className="hero-section min-h-screen flex items-center px-16 pb-8 bg-white -mt-3">
        <div className="hero-content flex-1">
          <div className="hero-container px-8 max-w-7xl mx-auto -mt-2.5">
        ...
        <div className="hero-image flex-1 flex flex-col items-center justify-center p-4">
          <div className="image-container relative rounded-2xl p-8 max-w-2xl w-full mx-auto bg-gradient-to-br from-white/95 to-gray-50/90 border-2 border-transparent bg-clip-padding shadow-2xl transition-all duration-300 hover:-translate-y-1.5 hover:shadow-3xl">
            <Image 
              src="/assets/picture.png" 
              alt="CommuniTrade Illustration" 
              width={600}
              height={400}
              className="hero-img w-full max-w-2xl h-auto object-contain"
            />
      ...
      {/* Services Section */}
      <section id="services" className="services-section py-8 max-w-7xl mx-auto mb-16 mt-12">
        <div className="container2 max-w-7xl mx-auto px-1">
          <h2 className="section-title text-4xl text-center mb-4 font-bold text-[#121731] tracking-wide">
            Our Services
          </h2>
          <p className="section-subtitle text-xl text-center text-[#728a9c] max-w-3xl mx-auto mb-12 leading-relaxed font-normal">
          ...
          <div className="services-grid grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 px-5">
            ...
            <div className="flip-card bg-transparent w-full h-64 perspective-1000 rounded-2xl shadow-lg transition-transform duration-600">
              <div className="flip-card-inner relative w-full h-full text-center transition-transform duration-600 transform-style-preserve-3d rounded-2xl hover:rotate-y-180">
                <div className="flip-card-front absolute w-full h-full backface-hidden rounded-2xl flex flex-col justify-center items-center p-5 border border-opacity-5 bg-white text-[#121731] shadow-md">
                ...
                <div className="flip-card-back absolute w-full h-full backface-hidden rounded-2xl flex flex-col justify-center items-center p-5 bg-gradient-to-br from-[#121731] to-[#728a9c] text-white transform rotate-y-180">
                  <h3 className="mb-3 text-2xl">Skill & Service Exchange</h3>
            ...
            <div className="flip-card bg-transparent w-full h-64 perspective-1000 rounded-2xl shadow-lg transition-transform duration-600">
              <div className="flip-card-inner relative w-full h-full text-center transition-transform duration-600 transform-style-preserve-3d rounded-2xl hover:rotate-y-180">
                ...
                <div className="flip-card-back absolute w-full h-full backface-hidden rounded-2xl flex flex-col justify-center items-center p-5 bg-gradient-to-br from-[#121731] to-[#728a9c] text-white transform rotate-y-180">
                  <h3 className="mb-3 text-2xl">Request Job Posting</h3>
                  <p className="text-sm opacity-90">
            ...
            <div className="flip-card bg-transparent w-full h-64 perspective-1000 rounded-2xl shadow-lg transition-transform duration-600">
              <div className="flip-card-inner relative w-full h-full text-center transition-transform duration-600 transform-style-preserve-3d rounded-2xl hover:rotate-y-180">
                ...
                <div className="flip-card-back absolute w-full h-full backface-hidden rounded-2xl flex flex-col justify-center items-center p-5 bg-gradient-to-br from-[#121731] to-[#728a9c] text-white transform rotate-y-180">
                  <h3 className="mb-3 text-2xl">Skill/Service Listings</h3>
                  <p className="text-sm opacity-90">
            ...
            <div className="flip-card bg-transparent w-full h-64 perspective-1000 rounded-2xl shadow-lg transition-transform duration-600">
              <div className="flip-card-inner relative w-full h-full text-center transition-transform duration-600 transform-style-preserve-3d rounded-2xl hover:rotate-y-180">
                ...
                <div className="flip-card-back absolute w-full h-full backface-hidden rounded-2xl flex flex-col justify-center items-center p-5 bg-gradient-to-br from-[#121731] to-[#728a9c] text-white transform rotate-y-180">
                  <h3 className="mb-3 text-2xl">Direct Messaging</h3>
                  <p className="text-sm opacity-90">
      ...
      {/* Guide Section */}
      <section id="guide" className="guide-section py-20 bg-gray-50">
        <div className="container max-w-7xl mx-auto px-6">
          <h2 className="section-title1 text-4xl text-center mb-4 font-bold text-[#121731]">
            How It Works
          </h2>
          <p className="section-subtitle1 text-xl text-center text-[#728a9c] max-w-3xl mx-auto mb-12 leading-relaxed">
            Begin your CommuniTrade experience with ease
          </p>
          
          <div className="steps-container flex gap-10 justify-center flex-wrap">
            <div className="steps-column flex-1 min-w-80 max-w-lg">
              {/* Step 1 */}
              <div className="step flex items-start mb-9 p-5 bg-white rounded-xl shadow-lg border-l-4 border-[#728a9c] transition-all duration-300 hover:shadow-xl hover:-translate-y-1 hover:border-[#121731]">
                <div className="step-number text-3xl font-bold text-[#121731] mr-5 min-w-10 text-center pt-1">
                  1
                </div>
                <div className="step-content">
                  <h3 className="text-xl font-semibold text-[#121731] mb-1">
              ...
              <div className="step flex items-start mb-9 p-5 bg-white rounded-xl shadow-lg border-l-4 border-[#728a9c] transition-all duration-300 hover:shadow-xl hover:-translate-y-1 hover:border-[#121731]">
                ...
                <div className="step-content">
                  <h3 className="text-xl font-semibold text-[#121731] mb-1">
                    Post What You Need or What You Can Offer
                  </h3>
                  <p className="text-sm text-gray-600 leading-relaxed">
      ...
      <section className="cta-section py-20 bg-gradient-to-br from-[#121731] to-[#728a9c] text-white text-center">
        <div className="container max-w-7xl mx-auto px-6">
          <h2 className="text-4xl font-bold mb-3">Ready to Join Your Community?</h2>
          <p className="text-xl mb-8 opacity-90">Start trading and building connections today</p>
          <Link href="/register" className="cta-button large text-lg py-4 px-10 bg-white text-[#121731] font-bold border-2 border-white rounded-full no-underline transition-all duration-300 hover:bg-transparent hover:text-white hover:-translate-y-1 hover:shadow-2xl">
            Sign Up Now
          </Link>
        </div>
      </section>
      ...
      <footer id="footer" className="footer bg-[#121731] text-white py-10">
        <div className="container3 max-w-7xl mx-auto px-5">
          <div className="footer-content flex justify-between flex-wrap border-b border-opacity-10 pb-5 mb-5">
            <div className="footer-section flex-1 min-w-50 mb-5">
              <div className="logo-container3 flex items-center gap-2 mb-3">
                <Image 
                  src="/assets/CommuniTrade.png" 
                  alt="CommuniTrade Logo" 
                  width={50}
                  height={50}
                  className="logo-img3 object-contain"
                />
                <div className="design1">
                  <p className="logo-text3 font-bold text-xl text-[#728a9c]">
                    Communi<span className="logo-text4 text-white">Trade</span>
                  </p>
                </div>
              </div>
            ...
            <div className="footer-section1 flex-1 min-w-50 mb-5">
              <h3 className="text-xl font-semibold mb-4 text-white">Contact Us</h3>
              <p className="mb-3 text-sm opacity-80">
                <i className="fas fa-envelope mr-2 text-[#728a9c]"></i> CommuniTrade@gmail.com
              </p>
              <p className="text-sm opacity-80">
                <i className="fas fa-phone mr-2 text-[#728a9c]"></i> 0912-345-6789
              </p>
            </div>
            
            <div className="footer-section2 flex-1 min-w-50 mb-5">
              <h3 className="text-xl font-semibold mb-4 text-white">Follow Us</h3>
              <div className="social-links flex">
                <a href="#" className="text-white text-2xl mr-4 transition-colors duration-300 hover:text-[#728a9c]">
