      ...
      <div className="account-layout grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 items-start max-w-[1200px] mx-auto">
              ...
              <div className="profile-info flex-1 flex flex-col gap-4 sm:gap-5 min-w-0 w-full">
                ...
                <div className="info-section flex flex-col gap-1 w-full">
                  ...
                  {isEditing ? (
                    ...
                    <p className="info-value text-[#121731] text-sm sm:text-base m-0 pl-2 break-words w-full">{user.phone}</p>
                  )}
                </div>
                ...
                {isEditing && (
                  <div className="edit-actions flex gap-3 sm:gap-4 mt-4 sm:mt-6 pt-3 sm:pt-4 border-t border-[#728a9c] w-full flex-wrap">
                    <button 
                      className="save-btn-large flex items-center gap-2 py-2 px-3 sm:px-4 bg-[#121731] text-white rounded-lg cursor-pointer font-semibold transition-colors text-xs sm:text-sm flex-1 min-w-[120px] sm:min-w-[140px] justify-center box-border hover:bg-[#728a9c]"
                      onClick={saveChanges}
                    >
                    ...
                    <button 
                      className="cancel-btn-large flex items-center gap-2 py-2 px-3 sm:px-4 border border-[#728a9c] text-[#728a9c] rounded-lg cursor-pointer font-semibold transition-colors text-xs sm:text-sm flex-1 min-w-[120px] sm:min-w-[140px] justify-center box-border hover:bg-[#b7c8d4] hover:text-white"
                      onClick={cancelEdit}
                    >
        ...
        <div className="posts-container flex flex-col">
          <div className="posts-card bg-white rounded-xl p-4 sm:p-5 shadow-md w-full box-border">
            ...
            <div className="posts-tabs flex flex-col sm:flex-row gap-2 sm:gap-3 mb-3 w-full flex-wrap">
            <div className="flex flex-col sm:flex-row justify-between w-full gap-2 sm:gap-4">
            <div className="flex flex-col sm:flex-row justify-between items-stretch sm:items-center w-full gap-2 sm:gap-4">
  <button
    className={`border-none py-2 sm:py-3 rounded-lg cursor-pointer transition-all duration-300 font-semibold text-xs sm:text-sm box-border w-full sm:w-auto sm:flex-1 lg:min-w-[270px] ${
      activeTab === 'offers'
          ...
          <div className="modal-content bg-white rounded-xl w-full max-w-[90vw] sm:max-w-[600px] max-h-[90vh] overflow-y-auto p-4 sm:p-6 shadow-lg box-border" onClick={(e) => e.stopPropagation()}>
            ...
            <form onSubmit={(e) => { e.preventDefault(); saveOfferEdit(); }} className="offer-form flex flex-col gap-4 sm:gap-5">
              ...
              <div className="form-actions flex justify-end gap-3 sm:gap-4 mt-4 sm:mt-5 flex-wrap">
                <button 
                  type="button" 
                  className="cancel-btn1 py-2 px-3 sm:px-4 border border-[#728a9c] text-[#728a9c] rounded-lg cursor-pointer font-medium transition-colors text-xs sm:text-sm hover:bg-[#b7c8d4] hover:text-white"
                ...
                <button 
                  type="submit" 
                  className="submit-btn1 py-2 px-3 sm:px-4 bg-[#121731] text-white rounded-lg cursor-pointer font-medium transition-colors text-xs sm:text-sm hover:bg-[#728a9c]"
                >
                  Save Changes
                </button>
              </div>
