              ...
              <div className="profile-info flex-1 flex flex-col gap-4 sm:gap-5 min-w-0 w-full">
                ...
                {isEditing && (
                  <div className="edit-actions flex gap-3 sm:gap-4 mt-4 sm:mt-6 pt-3 sm:pt-4 border-t border-[#728a9c] w-full flex-wrap">
                    <button 
                      className="save-btn-large flex items-center gap-2 py-2 px-3 sm:px-4 bg-[#121731] text-white rounded-lg cursor-pointer font-semibold transition-colors text-xs sm:text-sm flex-1 min-w-[120px] sm:min-w-[140px] justify-center box-border hover:bg-[#121731]"
                      onClick={saveChanges}
                    >
