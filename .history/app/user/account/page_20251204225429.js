...
export default function AccountPage() {
  ...
  // Initialize user data with session info
  useEffect(() => {
    if (session?.user) {
      setUser(prev => ({
        ...prev,
        ...
        // If you have a profile picture from session
  ...
  // User data - initialize with session data
  ...
  // Update profile picture to use session image
