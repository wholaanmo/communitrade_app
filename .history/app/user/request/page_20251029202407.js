              ...
              <div key={offer.id} className="profile-post-card bg-gray-50 rounded-lg p-5 border border-gray-300">
                ...
                <div className="post-details grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                  <div className="detail-item block">
                    <span className="block text-[#121731] font-semibold text-sm mb-1">Category:</span>
                    <span className="block text-gray-600">{offer.category}</span>
                  </div>
                  <div className="detail-item block">
                    <span className="block text-[#121731] font-semibold text-sm mb-1">Location:</span>
                    <span className="block text-gray-600">{offer.location}</span>
                  </div>
                  <div className="detail-item block">
                    <span className="block text-[#121731] font-semibold text-sm mb-1">Skills Requested:</span>
                    <span className="block text-gray-600">{offer.skillsRequested}</span>
                  </div>
                  <div className="detail-item block">
                    <span className="block text-[#121731] font-semibold text-sm mb-1">Schedule:</span>
                    <span className="block text-gray-600">{offer.schedule}</span>
                  </div>
                </div>

                {offer.additionalNotes && (
                  <div className="additional-notes mb-4">
                    <span className="block text-[#121731] font-semibold text-sm mb-1">Additional Notes:</span>
                    <p className="block text-gray-600">{offer.additionalNotes}</p>
                  </div>
                )}
            ...
            {currentProfile.skillRequests?.map((request) => (
              <div key={request.id} className="profile-post-card bg-gray-50 rounded-lg p-5 border border-gray-300">
                ...
                <div className="post-details grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                  <div className="detail-item block">
                    <span className="block text-[#121731] font-semibold text-sm mb-1">Category:</span>
                    <span className="block text-gray-600">{request.category}</span>
                  </div>
                  <div className="detail-item block">
                    <span className="block text-[#121731] font-semibold text-sm mb-1">Location:</span>
                    <span className="block text-gray-600">{request.location}</span>
                  </div>
                  <div className="detail-item block">
                    <span className="block text-[#121731] font-semibold text-sm mb-1">Skills Offered:</span>
                    <span className="block text-gray-600">{request.skillsOffered}</span>
                  </div>
                  <div className="detail-item block">
                    <span className="block text-[#121731] font-semibold text-sm mb-1">Schedule:</span>
                    <span className="block text-gray-600">{request.schedule}</span>
                  </div>
                </div>
                ...
                {request.additionalNotes && (
                  <div className="additional-notes mb-4">
                    <span className="block text-[#121731] font-semibold text-sm mb-1">Additional Notes:</span>
                    <p className="block text-gray-600">{request.additionalNotes}</p>
                  </div>
                )}
