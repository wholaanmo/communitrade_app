  ...
  return (
    <div className="skill-request-platform max-w-1200 mx-auto p-5">
      ...
      <div className="header-container flex justify-between items-center mb-8">
        ...
        <button 
          className="request-skill-btn flex items-center bg-[#121731] text-white p-3 rounded-lg font-medium transition-colors duration-300 hover:bg-[#121731]"
      ...
      {showForm && (
        <div className="modal-overlay fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50 p-5" onClick={() => setShowForm(false)}>
          <div className="modal-content bg-white rounded-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto p-8 shadow-xl" onClick={(e) => e.stopPropagation()}>
            ...
            <form onSubmit={(e) => { e.preventDefault(); submitForm(); }} className="request-form flex flex-col gap-5">
              ...
              <div className="form-actions flex justify-end gap-4 mt-5">
                <button type="button" className="btn cancel-btn p-3 border border-[#728a9c] text-[#728a9c] rounded-lg hover:bg-gray-100" onClick={cancelForm}>
                  Cancel
                </button>
                <button type="submit" className="btn submit-btn p-3 bg-[#121731] text-white rounded-lg hover:bg-[#121731]">
                  Submit Request
                </button>
              </div>
            </form>
      ...
      {/* Report Modal */}
      {showReportModal && (
        <div className="modal-overlay fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50 p-5" onClick={closeReportModal}>
          <div className="modal-content report-modal bg-white rounded-xl w-full max-w-lg max-h-[90vh] overflow-y-auto p-8 shadow-xl" onClick={(e) => e.stopPropagation()}>
            ...
            <form onSubmit={(e) => { e.preventDefault(); submitReport(); }} className="report-form flex flex-col gap-5">
              ...
              <div className="form-actions1 flex justify-between gap-4 w-full text-center">
                <button type="button" className="cancel-btn1 flex-1 flex justify-center items-center p-3 bg-white text-[#728a9c] border border-[#728a9c] rounded-lg hover:bg-[#728a9c] hover:text-white text-base">
                  Cancel
                </button>
                <button 
                  type="submit" 
                  className="submit-btn1 flex-1 flex justify-center items-center p-3 bg-[#dc3545] text-white border border-[#dc3545] rounded-lg hover:bg-[#c82333] hover:border-[#c82333] disabled:opacity-60 disabled:cursor-not-allowed text-base"
      ...
      {/* Profile Modal */}
      {showProfileModal && (
        <div className="modal-overlay fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50 p-5" onClick={closeProfileModal}>
          <div className="modal-content profile-modal bg-white rounded-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto p-8 shadow-xl" onClick={(e) => e.stopPropagation()}>
                ...
                <div className="posts-list flex flex-col gap-5">
                  {currentProfile.skillOffers?.map((offer) => (
                    <div key={offer.id} className="profile-post-card bg-gray-50 rounded-lg p-5 border border-gray-200">
                      ...
                      <div className="post-details grid grid-cols-2 gap-2 mb-4">
                      ...
                      {offer.additionalNotes && (
                        <div className="additional-notes mb-4">
                          <span className="detail-label font-semibold text-[#121731] text-sm">Additional Notes:</span>
                          <p className="detail-value text-[#555] text-base">{offer.additionalNotes}</p>
                        </div>
                      )}
                      {offer.proof && (
                  ...
                  {currentProfile.skillRequests?.map((request) => (
                    <div key={request.id} className="profile-post-card bg-gray-50 rounded-lg p-5 border border-gray-200">
                      ...
                      {request.additionalNotes && (
                        <div className="additional-notes mb-4">
                          <span className="detail-label font-semibold text-[#121731] text-sm">Additional Notes:</span>
                          <p className="detail-value text-[#555] text-base">{request.additionalNotes}</p>
                        </div>
                      )}
                      {request.proof && (
                        <div className="proof-image my-4">
            ...
            <div className="profile-actions flex justify-end mt-8 pt-5 border-t border-gray-200">
              <button className="btn close-btn p-3 bg-[#121731] text-white rounded-lg transition-colors duration-300 hover:bg-[#121731]" onClick={closeProfileModal}>
                Close
              </button>
            </div>
          </div>
