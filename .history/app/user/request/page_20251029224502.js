...
{showProfileModal && (
  ...
  >
    <div
      className="modal-content profile-modal bg-white rounded-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto p-8 shadow-[0_10px_30px_rgba(0,0,0,0.2)]"
    ...
    >
      ...
      <div className="profile-header flex items-center mb-8 pb-5 border-b border-gray-200">
        ...
        <div className="profile-info">
          ...
          <p className="profile-email text-[#728a9c] mb-1">{currentProfile.email}</p>
          <p className="profile-phone text-[#728a9c]">{currentProfile.phone}</p>
        </div>
      </div>
          ...
          <div className="linked-accounts flex flex-col gap-3">
            {currentProfile.linkedAccounts?.map((account, index) => (
              <a
                ...
                className="account-item flex items-center gap-3 p-3 bg-gray-50 rounded-lg no-underline text-current transition-colors hover:bg-gray-200"
              >
          ...
          <div className="posts-list flex flex-col gap-5">
            {currentProfile.skillOffers?.map((offer) => (
              <div key={offer.id} className="profile-post-card bg-gray-50 rounded-lg p-5 border border-gray-300">
                ...
                <p className="post-description text-gray-600 mb-4 leading-relaxed">{offer.description}</p>

                {/* Detail Items (label above value) */}
                <div className="post-details grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                  <div className="detail-item flex flex-col">
                    <span className="detail-label text-[#121731] font-semibold text-sm mb-1">Category:</span>
                    <span className="detail-value text-gray-600">{offer.category}</span>
                  </div>
                  <div className="detail-item flex flex-col">
                    <span className="detail-label text-[#121731] font-semibold text-sm mb-1">Location:</span>
                    <span className="detail-value text-gray-600">{offer.location}</span>
                  </div>
                  <div className="detail-item flex flex-col">
                    <span className="detail-label text-[#121731] font-semibold text-sm mb-1">Skills Requested:</span>
                    <span className="detail-value text-gray-600">{offer.skillsRequested}</span>
                  </div>
                  <div className="detail-item flex flex-col">
                    <span className="detail-label text-[#121731] font-semibold text-sm mb-1">Schedule:</span>
                    <span className="detail-value text-gray-600">{offer.schedule}</span>
                  </div>
                </div>

                {offer.additionalNotes && (
                  <div className="additional-notes mb-4">
                    <span className="detail-label text-[#121731] font-semibold text-sm">Additional Notes:</span>
                    <p className="detail-value text-gray-600 mt-1">{offer.additionalNotes}</p>
                  </div>
                )}
                ...
                <div className="post-actions flex gap-3 mt-4">
                  <button
                    className="btn report-btn flex items-center px-3 py-1.5 rounded-lg font-medium border border-[#e74c3c] text-[#e74c3c] transition-all hover:bg-[#e74c3c] hover:text-white text-sm"
                    onClick={() => openReportModalFromProfile(offer, currentProfile.fullName)}
                  >
                    <span className="material-icons mr-1 text-base">flag</span>
                    Report
                  </button>
                  <button className="btn contact-btn flex items-center px-3 py-1.5 rounded-lg font-medium border border-[#121731] text-[#121731] transition-all hover:bg-[#121731] hover:text-white text-sm">
          ...
          <div className="posts-list flex flex-col gap-5">
            {currentProfile.skillRequests?.map((request) => (
              <div key={request.id} className="profile-post-card bg-gray-50 rounded-lg p-5 border border-gray-300">
                ...
                <p className="post-description text-gray-600 mb-4 leading-relaxed">{request.description}</p>

                {/* Detail Items (label above value) */}
                <div className="post-details grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                  <div className="detail-item flex flex-col">
                    <span className="detail-label text-[#121731] font-semibold text-sm mb-1">Category:</span>
                    <span className="detail-value text-gray-600">{request.category}</span>
                  </div>
                  <div className="detail-item flex flex-col">
                    <span className="detail-label text-[#121731] font-semibold text-sm mb-1">Location:</span>
                    <span className="detail-value text-gray-600">{request.location}</span>
                  </div>
                  <div className="detail-item flex flex-col">
                    <span className="detail-label text-[#121731] font-semibold text-sm mb-1">Skills Offered:</span>
                    <span className="detail-value text-gray-600">{request.skillsOffered}</span>
                  </div>
                  <div className="detail-item flex flex-col">
                    <span className="detail-label text-[#121731] font-semibold text-sm mb-1">Schedule:</span>
                    <span className="detail-value text-gray-600">{request.schedule}</span>
                  </div>
                </div>
                ...
                {request.additionalNotes && (
                  <div className="additional-notes mb-4">
                    <span className="detail-label text-[#121731] font-semibold text-sm">Additional Notes:</span>
                    <p className="detail-value text-gray-600 mt-1">{request.additionalNotes}</p>
                  </div>
                )}
