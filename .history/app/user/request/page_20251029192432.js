...
{showProfileModal && (
  ...
  >
    <div
      className="modal-content bg-white rounded-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto p-8 shadow-[0_10px_30px_rgba(0,0,0,0.2)]"
      onClick={(e) => e.stopPropagation()}
    >
      {/* Header Section */}
      <div className="modal-header flex items-center mb-8 pb-5 border-b border-gray-200">
        {/* Example image or icon */}
        <div className="w-20 h-20 bg-gray-200 rounded-full mr-5"></div>
        <div className="flex flex-col">
          <h2 className="text-[#121731] text-xl font-semibold mb-1">Title or Name</h2>
          <p className="text-[#728a9c] text-sm">Subtext or secondary info</p>
        </div>
      </div>
      ...
      <div className="modal-body flex flex-col gap-6">
        ...
        <div className="section">
          <h3 className="text-[#121731] text-lg mb-4">Section Title 1</h3>
          <div className="section-content flex flex-col gap-3">
            <div className="p-3 bg-gray-50 rounded-lg border border-gray-200">Content item 1</div>
            <div className="p-3 bg-gray-50 rounded-lg border border-gray-200">Content item 2</div>
          </div>
        </div>

        {/* Section 2 */}
        <div className="section">
          <h3 className="text-[#121731] text-lg mb-4">Section Title 2</h3>
          <div className="section-content flex flex-col gap-3">
            <div className="p-3 bg-gray-50 rounded-lg border border-gray-200">Content item 1</div>
            <div className="p-3 bg-gray-50 rounded-lg border border-gray-200">Content item 2</div>
          </div>
        ...
        {/* Section 3 */}
        <div className="section">
          <h3 className="text-[#121731] text-lg mb-4">Section Title 3</h3>
          <div className="section-content flex flex-col gap-3">
            <div className="p-3 bg-gray-50 rounded-lg border border-gray-200">Content item 1</div>
            <div className="p-3 bg-gray-50 rounded-lg border border-gray-200">Content item 2</div>
          </div>
      ...
      {/* Footer / Actions */}
      <div className="modal-actions flex justify-end mt-8 pt-5 border-t border-gray-200">
        <button
