    ...
    <div className="relative">
      ...
      <div className="absolute bottom-4 right-4 flex gap-2">
        {isOwnPost ? (
          ...
          <>
            <RequestActionButton type="report" onClick={() => onReport(post)}>
              Report
            </RequestActionButton>
            <RequestActionButton type="contact" onClick={() => onContact(post)}>
              Contact
            </RequestActionButton>
            <RequestActionButton type="profile" onClick={() => onViewProfile(post)}>
              View Profile
            </RequestActionButton>
          </>
        )}
