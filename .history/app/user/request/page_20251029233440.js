      ...
      <div className="profile-header flex items-center mb-8 pb-5 border-b border-gray-200">
        ...
        <div className="profile-info">
          <div className="name-verified flex items-center gap-2 mb-2">
            <h2 className="text-[#121731] text-xl font-semibold text-left">
              ...
              <div key={offer.id} className="profile-post-card bg-gray-50 rounded-lg p-5 border border-gray-300">
                ...
                <div className="post-details grid grid-cols-1 md:grid-cols-2 gap-3 mb-4">
                  <div className="detail-item">
                    <span className="detail-label text-[#121731] font-semibold text-sm">Category:</span>
                    <span className="detail-value text-gray-600">{offer.category}</span>
                  </div>
                  <div className="detail-item">
                    <span className="detail-label text-[#121731] font-semibold text-sm">Location:</span>
                    <span className="detail-value text-gray-600">{offer.location}</span>
                  </div>
                  <div className="detail-item">
                    <span className="detail-label text-[#121731] font-semibold text-sm">Skills Requested:</span>
                    <span className="detail-value text-gray-600">{offer.skillsRequested}</span>
                  </div>
                  <div className="detail-item">
                    <span className="detail-label text-[#121731] font-semibold text-sm">Schedule:</span>
                ...
                <div className="post-actions flex gap-3 mt-4">
                  ...
                  >
                    <span className="material-icons mr-1 text-base">flag</span> Report
                  </button>
                  <button className="btn contact-btn flex items-center px-3 py-1.5 rounded-lg font-medium border border-[#121731] text-[#121731] transition-all hover:bg-[#121731] hover:text-white text-sm">
                    <span className="material-icons mr-1 text-base">message</span> Contact
                  </button>
                </div>
              </div>
            ))}
            ...
            {currentProfile.skillRequests?.map((request) => (
              <div key={request.id} className="profile-post-card bg-gray-50 rounded-lg p-5 border border-gray-300">
                ...
                <div className="post-details grid grid-cols-1 md:grid-cols-2 gap-3 mb-4">
                  ...
                  <div className="detail-item">
                    <span className="detail-label text-[#121731] font-semibold text-sm">Skills Offered:</span>
