    ...
    const loadPosts = async () => {
      ...
      try {
        ...
        const transformedPosts = fetchedPosts.map(post => ({
          ...
          timePosted: this.formatTimeAgo(post.createdAt),
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
        {filteredPosts.length > 0 ? (
          ...
          <div className="col-span-2">
            <EmptyState
              icon="search_off"
              title={searchQuery ? "No matching requests found" : "No requests yet"}
              description={searchQuery ? "Try adjusting your search terms" : "Be the first to create a request"}
