    ...
    <div className="flex flex-col gap-4 sm:gap-5">
      ...
      <div className="flex flex-col sm:flex-row justify-between gap-3 sm:gap-4 w-full text-center">
        <Button
          ...
          className="flex-1 bg-white text-[#728a9c] border border-[#728a9c] rounded-lg hover:bg-[#728a9c] hover:text-white"
        >
          Cancel
        </Button>
        ...
        <Button
          ...
          className="flex-1 bg-[#dc3545] text-white border border-[#dc3545] rounded-lg hover:bg-[#c82333] hover:border-[#c82333] disabled:opacity-60"
        >
          Confirm Report
        </Button>
      </div>
