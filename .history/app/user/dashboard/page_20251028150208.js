...
export default function Dashboard() {
  ...
  return (
    <div className="dashboard p-8 max-w-7xl mx-auto ml-8 mr-0">
      {/* Report Pop-up */}
      {showReportPopup && (
        <div className="report-popup-overlay fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-[1001]" onClick={closeReportPopup}>
      ...
      {showProfileModal && (
        <div className="modal-overlay fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-[1000] p-5" onClick={closeProfileModal}>
          <div className="modal-content profile-modal bg-white rounded-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto p-8 shadow-lg" onClick={(e) => e.stopPropagation()}>
                  ...
                  {currentProfile.skillOffers?.map((offer) => (
                    <div key={offer.id} className="profile-post-card bg-gray-50 rounded-lg p-5 border border-gray-200">
                      ...
                      <div className="post-actions flex gap-2.5 mt-4">
                        ...
                        <button className="btn2 contact-btn2 flex items-center py-1.5 px-4 rounded-lg font-medium transition-all duration-300 text-primary border border-primary hover:bg-primary hover:text-white">
                  ...
                  {currentProfile.skillRequests?.map((request) => (
                    <div key={request.id} className="profile-post-card bg-gray-50 rounded-lg p-5 border border-gray-200">
                      ...
                      <div className="post-actions flex gap-2.5 mt-4">
                        ...
                        <button className="btn2 contact-btn2 flex items-center py-1.5 px-4 rounded-lg font-medium transition-all duration-300 bg-primary text-white border border-primary hover:bg-white hover:text-primary">
                          <span className="material-icons mr-1.5 text-lg">message</span>
                          Contact
                        </button>
                      </div>
            ...
            <div className="profile-actions flex justify-end mt-8 pt-5 border-t border-gray-200">
              <button className="close-btn py-3 px-8 bg-primary text-white rounded-lg transition-colors duration-300 hover:bg-dark" onClick={closeProfileModal}>Close</button>
            </div>
          </div>
        </div>
      )}
            ...
            <div key={request.id} className="request-card bg-white rounded-2xl p-8 shadow-lg transition-all duration-300 hover:-translate-y-1 hover:shadow-xl min-h-[580px] flex flex-col">
              ...
              <div className="card-content mb-8 flex-1 flex flex-col gap-4">
                <div className="detail-item flex flex-col gap-2">
                  <label className="font-semibold text-primary text-sm">Request:</label>
                  <span className="detail-value text-dark text-base leading-relaxed">{request.request}</span>
                </div>
                <div className="detail-item flex flex-col gap-2">
                  <label className="font-semibold text-primary text-sm">Description:</label>
                ...
                <div className="detail-row flex gap-6">
                  ...
                  <div className="detail-item flex-1 flex flex-col gap-2">
                    <label className="font-semibold text-primary text-sm">Location:</label>
                    <span className="detail-value text-dark text-base leading-relaxed">{request.location}</span>
                  </div>
                </div>
                <div className="detail-item flex flex-col gap-2">
                  <label className="font-semibold text-primary text-sm">Skills Offered:</label>
                  <span className="detail-value text-dark text-base leading-relaxed">{request.skillsOffered.join(', ')}</span>
                </div>
                <div className="detail-item flex flex-col gap-2">
                  <label className="font-semibold text-primary text-sm">Schedule:</label>
                  <span className="detail-value text-dark text-base leading-relaxed">{request.schedule}</span>
                </div>
                <div className="detail-item flex flex-col gap-2">
                  <label className="font-semibold text-primary text-sm">Additional Notes:</label>
              ...
              <div className="card-actions flex gap-3 flex-wrap mt-auto">
                <button className="btn1 report-btn flex items-center py-2 px-5 rounded-lg font-medium transition-all duration-300 text-red-600 border border-red-600 hover:bg-red-600 hover:text-white flex-1 justify-center min-w-[110px]" onClick={() => openReportPopup(request.accountName)}>
                  <span className="material-icons text-lg mr-2">flag</span>
                  Report
                </button>
                <button className="btn1 contact-btn flex items-center py-2 px-5 rounded-lg font-medium transition-all duration-300 bg-primary text-white border border-primary hover:bg-white hover:text-primary flex-1 justify-center min-w-[110px]">
                  <span className="material-icons text-lg mr-2">message</span>
                  Contact
                </button>
                <button className="btn1 profile-btn flex items-center py-2 px-5 rounded-lg font-medium transition-all duration-300 text-gray-500 border border-gray-500 hover:bg-gray-500 hover:text-white flex-1 justify-center min-w-[110px]" onClick={() => openProfileModal(request)}>
        ...
        <div className="cards-container grid grid-cols-3 gap-8 mb-12">
          {filteredOffers.slice(0, 3).map((offer) => (
            <div key={offer.id} className="offer-card bg-white rounded-2xl p-8 shadow-lg transition-all duration-300 hover:-translate-y-1 hover:shadow-xl min-h-[580px] flex flex-col">
              ...
              <div className="card-content mb-8 flex-1 flex flex-col gap-4">
                <div className="detail-item flex flex-col gap-2">
                  <label className="font-semibold text-primary text-sm">Skills:</label>
                ...
                <div className="detail-item flex flex-col gap-2">
                  <label className="font-semibold text-primary text-sm">Skills Requested:</label>
              ...
              {/* Card Actions */}
              <div className="card-actions flex gap-3 flex-wrap mt-auto">
                <button className="btn1 report-btn flex items-center py-2 px-5 rounded-lg font-medium transition-all duration-300 text-red-600 border border-red-600 hover:bg-red-600 hover:text-white flex-1 justify-center min-w-[110px]" onClick={() => openReportPopup(offer.accountName)}>
                  <span className="material-icons text-lg mr-2">flag</span>
                  Report
                </button>
                <button className="btn1 contact-btn flex items-center py-2 px-5 rounded-lg font-medium transition-all duration-300 text-primary border border-primary hover:bg-primary hover:text-white flex-1 justify-center min-w-[110px]">
                  <span className="material-icons text-lg mr-2">message</span>
                  Contact
                </button>
                <button className="btn1 profile-btn flex items-center py-2 px-5 rounded-lg font-medium transition-all duration-300 text-gray-500 border border-gray-500 hover:bg-gray-500 hover:text-white flex-1 justify-center min-w-[110px]" onClick={() => openProfileModal(offer)}>
                  <span className="material-icons text-lg mr-2">account_circle</span>
                  View Profile
                </button>
              </div>
