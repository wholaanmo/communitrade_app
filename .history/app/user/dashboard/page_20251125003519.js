...
import ReportReasonItem from '@/components/molecules/ReportReasonItem';
  ...
  >
    ...
    >
      ...
      <form onSubmit={submitReport} className="flex flex-col gap-4 sm:gap-5">
        ...
        {/* LIST OF REASONS — exact copied layout */}
        <div className="flex flex-col gap-3">
          {reportReasons.map((reason) => (
            <label
              key={reason.value}
              className="flex items-center p-3 border border-gray-300 rounded-lg cursor-pointer transition-all hover:border-[#121731] hover:bg-gray-50 text-sm sm:text-base"
            >
              <Input
                type="radio"
                name="report-reason"
        ...
        {/* PROOF UPLOAD SECTION — exactly copied */}
        <div className="mb-4">
          <Label className="text-[#121731] font-semibold text-xs sm:text-sm block mb-2">
            Proof (Optional)
          </Label>
          ...
          <div className="flex items-center gap-3 mb-2">
            ...
            <label
              ...
              className="flex items-center px-4 py-2 bg-gray-100 border border-dashed border-gray-400 rounded-lg cursor-pointer transition-colors hover:bg-gray-200 text-xs sm:text-sm"
            >
              <span className="material-icons mr-2 text-[#728a9c] text-base">
                cloud_upload
              </span>
              Upload Proof
            </label>
            ...
            {proofFile && (
              <span className="text-[#728a9c] text-xs sm:text-sm italic">
                {proofFile.name}
              </span>
            )}
          </div>
