...
export default function Dashboard() {
  ...
  return (
    <div className="dashboard p-8 max-w-7xl mx-auto ml-8 mr-0">
      ...
      {showReportPopup && (
        <div
  className="report-popup-overlay fixed inset-0 bg-[rgba(211,211,211,0.5)] backdrop-blur-[1px] flex justify-center items-center z-[1001]"
...
{showProfileModal && (
  ...
  >
    <div className="modal-content profile-modal bg-white rounded-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto p-8 shadow-[0_10px_30px_rgba(0,0,0,0.2)] relative" onClick={(e) => e.stopPropagation()}>
      {/* Close Button */}
      <button 
      ...
      <div className="profile-actions flex justify-end mt-8 pt-5 border-t border-gray-200">
        <button className="px-5 py-2 bg-[#121731] text-white rounded-lg transition-colors hover:bg-[#728a9c]" onClick={closeProfileModal}>Close</button>
      </div>
    </div>
  </div>
)}
      ...
      <section className="requests-section">
        <div className="section-header flex justify-between items-center mb-8 px-2">
          ...
          <Link href="/user/request" className="see-all-btn flex items-center text-primary font-semibold text-base transition-colors duration-300 hover:text-dark py-2 px-4 rounded-lg hover:bg-gray-50 no-underline hover:no-underline">
            See All
      ...
      <section className="offers-section">
        <div className="section-header flex justify-between items-center mb-8 px-2">
          ...
          <Link href="/user/offer" className="see-all-btn flex items-center text-primary font-semibold text-base transition-colors duration-300 hover:text-dark py-2 px-4 rounded-lg hover:bg-gray-50 no-underline hover:no-underline">
            See All
            <span className="material-icons text-lg ml-1">chevron_right</span>
          </Link>
        </div>
