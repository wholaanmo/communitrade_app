...
export default function Dashboard() {
  ...
  return (
    <div className="dashboard p-8 max-w-7xl mx-auto ml-8 mr-0">
      {/* Report Pop-up */}
      {showReportPopup && (
        <div className="report-popup-overlay fixed inset-0 bg-gray-100 bg-opacity-90 flex justify-center items-center z-[1001]" onClick={closeReportPopup}>
      ...
      {/* Profile Modal */}
      {showProfileModal && (
        <div className="modal-overlay fixed inset-0 bg-gray-100 bg-opacity-90 flex justify-center items-center z-[1000] p-5" onClick={closeProfileModal}>
