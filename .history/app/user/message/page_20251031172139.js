...
export default function SkillRequestPlatform() {
  ...
  return (
    <div className="skill-request-platform max-w-1200 mx-auto p-5 overflow-hidden">
      {/* Search Bar */}
...
>
  ...
  Request Skill
      ...
      {/* Posts Container */}
      <div className="posts-container grid grid-cols-1 md:grid-cols-2 gap-6 overflow-y-auto" style={{ maxHeight: 'calc(100vh - 200px)' }}>
  ...
  >
    ...
    >
      ...
      <style jsx global>{`
        ...
        /* Allow scrolling only in conversation and posts sections */
        .posts-container {
