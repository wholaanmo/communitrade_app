...
export default function MessagePage() {
  ...
  return (
    <div className="message-page flex h-[calc(100vh-60px)] -mt-[3px] bg-[#ffffff] overflow-hidden">
      ...
      <div className={`conversation-sidebar bg-white border-r border-[#728a9c] flex flex-col transition-all duration-300 overflow-hidden ${!isSidebarExpanded ? 'sidebar-collapsed w-[60px]' : 'w-[350px]'} ml-[-10px]`}>
