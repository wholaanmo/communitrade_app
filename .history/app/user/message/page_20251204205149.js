...
export default function MessagePage() {
  ...
  useEffect(() => {
    ...
    handleUrlParams();
  }, [userIdFromUrl, userNameFromUrl, userEmailFromUrl, userPictureFromUrl, isMobile, conversations, isInitializing, getCurrentUserId, session, hasProcessedUrlParams]); // Add hasProcessedUrlParams to dependencies
