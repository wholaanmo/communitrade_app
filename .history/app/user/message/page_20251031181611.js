...
export default function MessagePage() {
  ...
  return (
    <div className="message-page flex h-[calc(100vh-60px)] -mt-[3px] bg-[#ffffff] overflow-hidden">
      {/* Sidebar with conversation list */}
      <div className={`conversation-sidebar bg-white border-r border-[#728a9c] flex flex-col transition-all duration-300 overflow-hidden ${!isSidebarExpanded ? 'sidebar-collapsed w-[60px]' : 'w-[350px]'} ml-[-30px]`}>
        ...
        {activeConversation ? (
          <div className="chat-container flex flex-col h-full w-full">
            ...
            <div 
              ...
              className="messages-container flex-1 p-4 overflow-y-auto flex flex-col gap-4 bg-[#f8f9fa]"
            >
