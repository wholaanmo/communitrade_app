...
export default function MessagePage() {
  ...
  }, [userIdFromUrl, userNameFromUrl, userEmailFromUrl, findOrCreateConversation, isMobile]);
  ...
  // Effects
  useEffect(() => {
    // Select first conversation by default (if no URL parameters)
    if (conversations.length > 0 && !activeConversation && !userIdFromUrl) {
      selectConversation(conversations[0]);
    }
  }, [conversations, activeConversation, selectConversation, userIdFromUrl]);
