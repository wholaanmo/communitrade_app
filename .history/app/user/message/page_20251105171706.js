...
export default function MessagePage() {
  ...
  return (
    <div className="message-page fixed top-[60px] sm:top-[64px] left-0 sm:left-[68px] right-0 bottom-0 flex bg-[#ffffff] overflow-hidden">
      ...
      <div className={`conversation-sidebar bg-white border-r border-[#728a9c] flex flex-col transition-all duration-300 overflow-hidden ${
        ...
        <h2 className="m-0 text-[#121731] text-lg sm:text-xl md:text-2xl leading-[2rem]">Messages</h2>
          {isMobile && (
            <button 
