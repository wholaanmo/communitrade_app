    ...
    try {
      ...
      if (editingPostId) {
        ...
        try {
          ...
          // Don't throw error here - the post was updated successfully
        }
        ...
        // Add to user's skillOffers in their profile data
        try {
          const userRef = ref(db, `users/${userId}`);
          ...
          // Create a new offer object for the user's profile
          const userOfferData = {
            id: newPost.id,
            skills: postData.title,
            description: postData.description,
          ...
          // Add to user's skillOffers array
