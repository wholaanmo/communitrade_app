  ...
  return (
    <div className="max-w-[1200px] mx-auto p-5">
      ...
      <div className="flex justify-between items-center mb-8">
        ...
        <button 
          className="flex items-center bg-[#121731] text-white px-5 py-2 rounded-lg font-medium transition-colors hover:bg-[#555555]"
      ...
      {showForm && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50 p-5" onClick={() => setShowForm(false)}>
          <div className="bg-white rounded-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto p-8 shadow-[0_10px_30px_rgba(0,0,0,0.2)]" onClick={e => e.stopPropagation()}>
            ...
            <form onSubmit={submitForm} className="flex flex-col gap-5">
              ...
              <div className="flex justify-end gap-4 mt-5">
                <button type="button" className="px-6 py-3 border border-[#728a9c] text-[#728a9c] rounded-lg transition-colors hover:bg-gray-100" onClick={cancelForm}>
                  Cancel
                </button>
                <button type="submit" className="px-6 py-3 bg-[#121731] text-white rounded-lg transition-colors hover:bg-[#555555]">
                  Submit Offer
                </button>
              </div>
            </form>
      ...
      {/* Report Modal */}
      {showReportModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50 p-5" onClick={closeReportModal}>
          <div className="bg-white rounded-xl w-full max-w-md max-h-[90vh] overflow-y-auto p-8 shadow-[0_10px_30px_rgba(0,0,0,0.2)]" onClick={e => e.stopPropagation()}>
            ...
            <form onSubmit={submitReport} className="flex flex-col gap-5">
              ...
              <div className="flex justify-between gap-4 w-full text-center">
                ...
                <button 
                  type="submit" 
                  className="flex-1 flex justify-center items-center px-4 py-3 bg-[#dc3545] text-white border border-[#dc3545] rounded-lg transition-colors hover:bg-[#c82333] hover:border-[#c82333] text-sm"
      ...
      {/* Profile Modal */}
      {showProfileModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50 p-5" onClick={closeProfileModal}>
          <div className="bg-white rounded-xl w-full max-w-4xl max-h-[95vh] overflow-y-auto p-8 shadow-[0_10px_30px_rgba(0,0,0,0.2)]" onClick={e => e.stopPropagation()}>
