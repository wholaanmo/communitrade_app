...
export default function SkillOfferPlatform() {
  ...
  return (
    <div className="max-w-[1200px] mx-auto p-4 sm:p-5">
        ...
        {filteredPosts.map(post => (
          <div key={post.id} className="bg-white rounded-xl shadow-[0_4px_15px_rgba(0,0,0,0.1)] overflow-hidden transition-all hover:translate-y-[-5px] hover:shadow-[0_8px_25px_rgba(0,0,0,0.15)]">
            ...
            <div className="p-4 sm:p-5">
              <h2 className="text-[#121731] text-lg sm:text-xl mb-3">{post.skills}</h2>
              <p className="text-gray-600 mb-4 sm:mb-5 leading-relaxed text-sm sm:text-base">{post.description}</p>
              
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 mb-4 sm:mb-5">
                <div className="flex flex-col">
                  <span className="text-[#121731] font-semibold text-xs sm:text-sm mb-1">Category:</span>
                  <span className="text-gray-600 text-sm sm:text-base">{post.category}</span>
                </div>
                <div className="flex flex-col">
                  <span className="text-[#121731] font-semibold text-xs sm:text-sm mb-1">Location:</span>
                  <span className="text-gray-600 text-sm sm:text-base">{post.location}</span>
                </div>
                <div className="flex flex-col">
                  <span className="text-[#121731] font-semibold text-xs sm:text-sm mb-1">Skills Requested:</span>
                  <span className="text-gray-600 text-sm sm:text-base">{post.skillsRequested}</span>
                </div>
                <div className="flex flex-col">
                  <span className="text-[#121731] font-semibold text-xs sm:text-sm mb-1">Schedule:</span>
                  <span className="text-gray-600 text-sm sm:text-base">{post.schedule}</span>
                </div>
              </div>
              ...
              {post.additionalNotes && (
                <div className="mt-3 sm:mt-4">
                  ...
                  <p className="text-gray-600 mt-1 text-sm sm:text-base">{post.additionalNotes}</p>
                </div>
              )}
            </div>
            ...
            <div className="flex flex-wrap gap-2 sm:gap-3 p-4 sm:p-5 border-t border-gray-200">
              <button 
                className="flex items-center px-3 py-2 rounded-lg font-medium border border-[#e74c3c] text-[#e74c3c] transition-all hover:bg-[#e74c3c] hover:text-white text-xs sm:text-sm flex-1 sm:flex-none justify-center min-w-[100px]"
                onClick={() => openReportModal(post)}
              >
                <span className="material-icons mr-1 text-base">flag</span>
                Report
              </button>
              <button className="flex items-center px-3 py-2 rounded-lg font-medium border border-[#121731] text-[#121731] transition-all hover:bg-[#121731] hover:text-white text-xs sm:text-sm flex-1 sm:flex-none justify-center min-w-[100px]">
                <span className="material-icons mr-1 text-base">message</span>
                Contact
              </button>
              <button 
                className="flex items-center px-3 py-2 rounded-lg font-medium border border-[#728a9c] text-[#728a9c] bg-white transition-all hover:bg-[#728a9c] hover:text-white text-xs sm:text-sm flex-1 sm:flex-none justify-center min-w-[100px]"
      ...
      {showForm && (
        <div
          className="modal-overlay fixed inset-0 bg-[rgba(211,211,211,0.5)] backdrop-blur-[1px] flex justify-center items-center z-[1000] p-4"
        ...
        >     
          <div className="bg-white rounded-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto p-6 sm:p-8 shadow-[0_10px_30px_rgba(0,0,0,0.2)]" onClick={e => e.stopPropagation()}>
            <h2 className="text-[#121731] text-xl sm:text-2xl text-center mb-6">Offer a Skill</h2>
            
            <form onSubmit={submitForm} className="flex flex-col gap-4 sm:gap-5">
              <div className="flex flex-col">
                <label htmlFor="skills" className="text-[#121731] font-semibold mb-2 text-sm sm:text-base">Skills *</label>
                <input 
                  type="text" 
                  id="skills" 
                  ...
                  className="p-3 border border-gray-300 rounded-lg text-sm sm:text-base transition-colors focus:border-[#121731] outline-none"
                />
              </div>
              
              <div className="flex flex-col">
                <label htmlFor="description" className="text-[#121731] font-semibold mb-2 text-sm sm:text-base">Description *</label>
                <textarea 
                  id="description" 
                  ...
                  className="p-3 border border-gray-300 rounded-lg text-sm sm:text-base transition-colors focus:border-[#121731] outline-none resize-vertical"
                />
              </div>
              
              <div className="flex flex-col">
                <label htmlFor="category" className="text-[#121731] font-semibold mb-2 text-sm sm:text-base">Category *</label>
                <select 
                  id="category" 
              ...
              <div className="flex flex-col">
                <label htmlFor="location" className="text-[#121731] font-semibold mb-2 text-sm sm:text-base">Location *</label>
                <input 
                  type="text" 
                  id="location" 
              ...
              <div className="flex flex-col">
                <label htmlFor="skills-requested" className="text-[#121731] font-semibold mb-2 text-sm sm:text-base">Skills Requested</label>
                <input 
                  type="text" 
                  id="skills-requested" 
              ...
              <div className="flex flex-col">
                <label htmlFor="schedule" className="text-[#121731] font-semibold mb-2 text-sm sm:text-base">Schedule *</label>
                <input 
                  type="text" 
                  id="schedule" 
              ...
              <div className="flex flex-col">
                <label htmlFor="additional-notes" className="text-[#121731] font-semibold mb-2 text-sm sm:text-base">Additional Notes</label>
                <textarea 
                  id="additional-notes" 
              ...
              <div className="flex flex-col">
                <label htmlFor="proof" className="text-[#121731] font-semibold mb-2 text-sm sm:text-base">Proof (Optional)</label>
                <div className="flex items-center gap-3">
                  <input 
                    ...
                    className="hidden"
                  />
                  <label htmlFor="proof" className="flex items-center px-4 py-2 bg-gray-100 border border-dashed border-gray-400 rounded-lg cursor-pointer transition-colors hover:bg-gray-200 text-sm">
      ...
      {showReportModal && (
        <div
          className="modal-overlay fixed inset-0 bg-[rgba(211,211,211,0.5)] backdrop-blur-[1px] flex justify-center items-center z-[1001] p-4"
        ...
        >
          ...
          >     
            ...
            <form onSubmit={submitReport} className="flex flex-col gap-4 sm:gap-5">
              <div className="flex flex-col gap-3">
                {reportReasons.map(reason => (
                  <label key={reason.value} className="flex items-center p-3 border border-gray-300 rounded-lg cursor-pointer transition-all hover:border-[#121731] hover:bg-gray-50 text-sm sm:text-base">
                    <input 
                      type="radio" 
                      value={reason.value} 
              ...
              <div className="mb-4">
                <label className="text-[#121731] font-semibold text-xs sm:text-sm block mb-2">Proof (Optional)</label>
                <div className="flex items-center gap-3 mb-2">
                  <input 
                    ...
                    className="hidden"
                  />
                  <label htmlFor="proof-upload" className="flex items-center px-4 py-2 bg-gray-100 border border-dashed border-gray-400 rounded-lg cursor-pointer transition-colors hover:bg-gray-200 text-xs sm:text-sm">
        ...
        >
          ...
          >
            <div className="flex flex-col sm:flex-row items-start sm:items-center mb-6 sm:mb-8 pb-5 border-b border-gray-200">
              <img src={currentProfile.userPicture} alt={currentProfile.fullName} className="w-16 h-16 sm:w-20 sm:h-20 rounded-full object-cover mr-0 sm:mr-5 mb-4 sm:mb-0" />
              <div>
