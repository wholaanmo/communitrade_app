...
export default function SkillRequestPlatform() {
  ...
  return (
    <div className="skill-request-platform max-w-[1200px] mx-auto p-5">
      ...
      {showDeleteModal && (
        <div className="modal-overlay delete-overlay fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center p-5 z-[2000]" onClick={closeDeleteModal}>
      ...
      {showRemoveModal && (
        <div className="modal-overlay remove-overlay fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center p-5 z-[2000]" onClick={closeRemoveModal}>
          <div className="modal-content remove-modal bg-white rounded-xl w-full max-w-md max-h-[90vh] overflow-y-auto shadow-2xl p-8" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="remove-actions flex gap-4 justify-center">
              <button className="btn confirm-remove-btn px-6 py-3 bg-red-600 text-white border-none rounded-lg cursor-pointer transition-colors duration-300 hover:bg-red-700" onClick={confirmRemove}>
                Confirm Remove
              </button>
              <button className="btn cancel-btn px-6 py-3 bg-gray-600 text-white border-none rounded-lg cursor-pointer transition-colors duration-300 hover:bg-gray-700" onClick={closeRemoveModal}>
                Cancel
              </button>
            </div>
          </div>
      ...
      {/* Profile Modal */}
      {showProfileModal && (
        <div className="modal-overlay profile-overlay fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center p-5 z-[1000]" onClick={closeProfileModal}>
          <div className="modal-content profile-modal bg-white rounded-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto shadow-2xl p-8" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="profile-actions flex justify-end mt-8 pt-5 border-t border-gray-300">
              <button className="btn close-btn px-8 py-3 bg-[#121731] text-white border-none rounded-lg cursor-pointer transition-colors duration-300 hover:bg-[#0a0f23]" onClick={closeProfileModal}>
                Close
              </button>
            </div>
          </div>
