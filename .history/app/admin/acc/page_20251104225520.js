  ...
  return (
    <div className="admin-dashboard max-w-6xl mx-auto p-4 sm:p-5 lg:p-6">
      ...
      <div className="admin-header mb-6 sm:mb-8">
        <h1 className="text-[#121731] text-2xl sm:text-3xl font-semibold m-0">Admin</h1>
      </div>
      ...
      <div className="profile-container bg-white rounded-xl p-4 sm:p-5 shadow-md mb-6 sm:mb-8">
        <div className="profile-info flex items-center gap-3 sm:gap-4">
          <span className="material-icons user-icon text-[#121731] text-4xl sm:text-5xl">account_circle</span>
          <span className="admin-email text-base sm:text-lg font-medium text-[#121731]">admin@skillswap.com</span>
        </div>
      </div>
              ...
              {deactivatedAccounts.map((account) => (
                <div key={account.id} className="account-item bg-gray-50 rounded-lg p-4 sm:p-5 mb-3 sm:mb-4 border border-gray-200 relative">
                  <div className="account-header flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4 mb-3 sm:mb-4">
                    <img src={account.profilePicture} alt={account.fullName} className="profile-picture w-12 h-12 sm:w-15 sm:h-15 rounded-full object-cover self-center sm:self-auto" />
                ...
                <div key={post.id} className="post-item bg-gray-50 rounded-lg p-4 sm:p-5 mb-4 sm:mb-5 border border-gray-200">
                  <div className="post-header-user flex flex-col sm:flex-row sm:items-center gap-3 mb-3 sm:mb-4 pb-3 sm:pb-4 border-b border-gray-200">
                    <div className="flex items-center gap-3 w-full sm:w-auto">
                      <img src={post.userProfilePicture} alt={post.userFullName} className="user-profile-picture w-8 h-8 sm:w-10 sm:h-10 rounded-full object-cover" />
      ...
      {showProfileModal && (
        <div 
          className="modal-overlay profile-overlay fixed inset-0 bg-[rgba(211,211,211,0.5)] backdrop-blur-[1px] flex justify-center items-start sm:items-center p-3 sm:p-4 lg:p-5 z-50 overflow-y-auto"
        ...
        >
          ...
          >
            <div className="profile-header flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-5 border-b border-gray-300 pb-4 sm:pb-5 mb-4 sm:mb-5">
              <img src={currentProfile.userPicture} alt={currentProfile.fullName} className="profile-picture w-20 h-20 sm:w-25 sm:h-25 rounded-full object-cover self-center sm:self-auto" />
                    ...
                    <div key={offer.id} className="profile-post-card bg-gray-50 rounded-lg p-3 sm:p-4 lg:p-5 border border-gray-200">
                      ...
                      {offer.proof && (
                        <div className="proof-image my-3 sm:my-4">
                          <img src={offer.proof} alt="Proof" className="proof-thumbnail w-full max-w-40 sm:max-w-50 rounded-lg border border-gray-300" />
                        </div>
                      )}
                ...
                <div className="posts-list flex flex-col gap-4 sm:gap-5">
                  {currentProfile.skillRequests?.map((request) => (
                    <div key={request.id} className="profile-post-card bg-gray-50 rounded-lg p-3 sm:p-4 lg:p-5 border border-gray-200">
                      ...
                      {request.proof && (
                        <div className="proof-image my-3 sm:my-4">
                          <img src={request.proof} alt="Proof" className="proof-thumbnail w-full max-w-40 sm:max-w-50 rounded-lg border border-gray-300" />
                        </div>
                      )}
                      <div className="post-actions flex flex-col xs:flex-row gap-2 sm:gap-2.5 mt-3 sm:mt-4">
                        <button 
        ...
        >
          ...
          >
            ...
            <div className="delete-actions flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
              <button 
                className="confirm-delete-btn px-4 sm:px-6 py-2 sm:py-3 bg-[#e74c3c] text-white border-none rounded cursor-pointer transition-colors duration-300 hover:bg-[#c0392b] text-sm sm:text-base"
                onClick={confirmDelete}
              >
                Confirm Delete
              </button>
              <button 
                className="cancel-btn px-4 sm:px-6 py-2 sm:py-3 bg-gray-600 text-white border-none rounded cursor-pointer transition-colors duration-300 hover:bg-gray-700 text-sm sm:text-base"
                onClick={closeDeleteModal}
              >
                Cancel
              </button>
