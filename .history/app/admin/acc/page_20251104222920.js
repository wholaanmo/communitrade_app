              ...
              {removedPosts.map((post) => (
                <div key={post.id} className="post-item bg-gray-50 rounded-lg p-5 mb-5 border border-gray-200">
                  <div className="post-header-user flex items-center gap-3 mb-4 pb-4 border-b border-gray-200">
                    ...
                    <button 
  className="view-profile-btn bg-gradient-to-br from-[#121731] to-[#728a9c] text-white border-none px-3 py-1.5 rounded font-medium cursor-pointer text-xs transition-all duration-300 hover:-translate-y-0.5 hover:shadow-md whitespace-nowrap text-center"
...
<button 
  className="btn contact-btn flex items-center px-3 py-1.5 rounded-lg font-medium transition-all duration-300 text-[#121731] border border-[#121731] hover:bg-[#121731] hover:text-white text-sm"
>
  ...
  Contact
            ...
            <button 
  className="close-btn1 px-5 py-2 bg-[#121731] text-white border-none rounded-lg cursor-pointer transition-colors duration-300 hover:bg-[#728a9c]"
  onClick={closeProfileModal}
>
  Close
</button>
