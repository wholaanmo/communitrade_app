  ...
  See All
        ...
        <div className="stat-card kept-stat bg-white rounded-xl p-6 shadow-lg transition-transform duration-300 hover:-translate-y-1 hover:shadow-xl">
          <div className="stat-header flex justify-between items-start mb-5">
            ...
            <button 
              className="see-all-btn bg-[#121731] text-white border-none px-4 py-2 rounded font-medium cursor-pointer transition-colors duration-300 whitespace-nowrap hover:bg-[#121731]"
              ...
              {deactivatedAccounts.map((account) => (
                <div key={account.id} className="account-item bg-gray-50 rounded-lg p-5 mb-4 border border-gray-200 relative">
                  <div className="account-header flex items-center gap-4 mb-4">
                    ...
                    <button 
                      className="reactivate-btn bg-[#27ae60] text-white border-none px-4 py-2 rounded font-medium cursor-pointer transition-colors duration-300 absolute top-4 right-4 hover:bg-[#219653]"
      ...
      {showProfileModal && (
        <div 
          className="modal-overlay profile-overlay fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50 p-5"
