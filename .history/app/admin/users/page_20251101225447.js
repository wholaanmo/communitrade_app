            ...
            <div className="profile-header flex items-center mb-8 pb-5 border-b border-gray-300">
              ...
              <div className="profile-info">
                ...
                <div className="verification-controls flex items-center justify-between mb-2">
                  ...
                  <button 
  className="verify-btn bg-[#121731] border border-[#728a9c] rounded px-2 py-1 text-sm cursor-pointer transition-all duration-300 ml-3 text-white hover:bg-[#1f2547]" 
