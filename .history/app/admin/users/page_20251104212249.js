        ...
        {filteredUsers.map(user => (
          <div key={user.id} className="user-profile-container bg-white rounded-xl p-6 shadow-sm border border-gray-300 transition-all duration-200 hover:-translate-y-1 hover:shadow-md">
            <div className="user-main-info flex justify-between items-start mb-4">
              ...
              <button 
  className="view-records-btn bg-gradient-to-r from-[#121731] via-[#2f3f57] to-[#728a9c] text-white font-medium border-none px-6 py-3 rounded-lg cursor-pointer text-sm transition-all duration-500 bg-[length:200%_200%] hover:bg-[length:250%_250%] hover:bg-gradient-to-l hover:from-[#728a9c] hover:via-[#4f6178] hover:to-[#121731] hover:shadow-[0_0_25px_rgba(114,138,156,0.6)] hover:-translate-y-1 hover:scale-105 whitespace-nowrap min-w-[120px] text-center"
            ...
            <div className="profile-header flex items-center mb-8 pb-5 border-b border-gray-300">
              ...
              <div className="profile-info">
                ...
                <div className="verification-controls flex items-center justify-between mb-2">
                  ...
                  <button 
  className="verify-btn bg-[#121731] border border-[#728a9c] rounded px-2 py-1 text-sm cursor-pointer transition-all duration-300 ml-3 text-white hover:bg-[#728a9c]" 
...
>
  ...
  <button className="btn confirm-deactivate-btn px-5 py-2 bg-red-600 text-white border-none rounded-lg cursor-pointer transition-colors duration-300 hover:bg-red-700" onClick={confirmDeactivation}>
    Confirm Deactivation
  </button>
  <button 
  className="btn cancel-btn px-5 py-2 border border-[#728a9c] text-[#728a9c] rounded-lg cursor-pointer transition-colors duration-300 hover:bg-[#b7c8d4] hover:text-white" 
  onClick={closeDeactivateModal}
>
  Cancel
</button>
  ...
  <button className="btn confirm-delete-btn px-5 py-2 bg-red-600 text-white border-none rounded-lg cursor-pointer transition-colors duration-300 hover:bg-red-700" onClick={confirmDelete}>
    Confirm Delete
  </button>
  <button 
    className="btn cancel-btn px-5 py-2 border border-[#728a9c] text-[#728a9c] rounded-lg cursor-pointer transition-colors duration-300 hover:bg-[#b7c8d4] hover:text-white" 
