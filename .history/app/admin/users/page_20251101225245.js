...
export default function UsersManagement() {
  ...
  <button className="btn cancel-btn px-5 py-2 bg-gray-600 text-white border-none rounded-lg cursor-pointer transition-colors duration-300 hover:bg-gray-700" onClick={closeDeactivateModal}>
    Cancel
  </button>
</div>
