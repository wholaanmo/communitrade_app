...
export default function AdminOffersPage() {
  ...
  const [currentProfileName, setCurrentProfileName] = useState('') // Add this state
  ...
  const handleViewProfile = (post) => {
    ...
    setCurrentProfileName(profile.fullName) // Set the current profile name
  ...
  return (
    <>
      ...
      <DeleteModal
        ...
        post={postToDelete}
        profileName={currentProfileName} // Pass the profile name
      />
