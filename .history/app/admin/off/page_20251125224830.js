  ...
  return (
    <>
      ...
      >
        <div className="text-center mb-6">
          <p className="text-gray-700 mb-4">
            Are you sure you want to remove this reported post? This action cannot be undone. The post will be permanently removed from the platform.
          </p>
        </div>
        <div className="flex gap-3 justify-center">
