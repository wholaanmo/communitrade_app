...
export default function Register() {
    ...
    return (
        <>
            ...
            <div className="flex justify-center items-center min-h-screen w-full p-4 bg-cover bg-center bg-no-repeat" style={{ backgroundImage: "url('/assets/background.png')" }}>
