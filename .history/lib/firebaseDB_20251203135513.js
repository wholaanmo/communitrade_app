...
import { 
  ...
  export const postsDB = {
    ...
    async createPost(type, postData) {
      try {
        // Ensure type is plural (requests/offers)
      ...
      try {
        ...
        if (snapshot.exists()) {
          snapshot.forEach((childSnapshot) => {
            ...
            console.log(`Post ${childSnapshot.key}:`, postData);
