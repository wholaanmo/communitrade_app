...
export const messagingDB = {
  ...
  async getOrCreateConversation(currentUserId, otherUserId, otherUserName = '', otherUserEmail = '', otherUserPicture = '') {
    try {
      ...
      const conversationData = {
        ...
        participants: {
          user1: currentUserId,
          user1Name: session?.user?.name || 'Current User',
          user1Email: session?.user?.email || '',
          user1Picture: session?.user?.image || 'https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?ixlib=rb-4.0.3&auto=format&fit=crop&w=100&q=80',
          user2: otherUserId,
          user2Name: otherUserName || 'Other User',
          user2Email: otherUserEmail || '',
          user2Picture: otherUserPicture || 'https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?ixlib=rb-4.0.3&auto=format&fit=crop&w=100&q=80'
        },
        lastMessage: '',
